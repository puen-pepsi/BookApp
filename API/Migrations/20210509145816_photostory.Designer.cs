...
namespace API.Migrations
{
    ...
    [Migration("20210509145816_photostory")]
    partial class photostory
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Entities.PhotoStory", b =>
                {
                    b.HasOne("API.Entities.Story", null)
                        .WithOne("PhotoStory")
                        .HasForeignKey("API.Entities.PhotoStory", "StoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
